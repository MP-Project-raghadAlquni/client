      ...
      <h2 className="bodyHomeh2"> Pending Doctor </h2>
           <h5 className="bodyHomeh5">  Welcome to Readings App</h5>
            ...
            <aside className="RightInfo0">
              <p className="bodyHomeh1"> Full Name :  <span className="text">{onePending.fullName} </span> </p>
              <p className="bodyHomeh1"> File Number : <span className="text"> {onePending.fileNumber} </span></p>
             </aside>
              <aside className="RightInfo">
              <p className="bodyHomeh1"> Age:  <span className="text">{onePending.age}</span> </p>
              <p className="bodyHomeh1"> <IoWomanSharp /><FaMale className="male" />  <span className="text"> {onePending.gender} </span></p>
              </aside>
              <aside className="RightInfo2">
              <p className="bodyHomeh1"> <AiFillPhone className="infoIcon"/> <span className="text"> {onePending.phoneNumber} </span></p>
              <p className="bodyHomeh1"> <MdEmail className="infoIcon"/>  <span className="text"> {onePending.email} </span></p>
              </aside>
              </div>
              <aside className="licenseSide">
              <h2 className="TitleInfo"> Certificates and Licenses </h2>
              <p> Health Certificates  <TiArrowRightOutline className="ArrowIcon"/> <a href={onePending.certificates}> Certificates </a> </p>
              <p> A Certified Letter from the Employer <TiArrowRightOutline className="ArrowIcon"/><a href={onePending.letter}> Letter </a> </p>
              <p> A Health License from the Health Institution for Health Specialties <TiArrowRightOutline className="ArrowIcon"/> <a href={onePending.license}> License </a></p>
              
              
              </aside>
    <button className="rejectAcceptBtn Accept" onClick={AcceptDoctor}> accept Doctor? </button>
    <button className="rejectAcceptBtn reject" onClick={RejectedDoctor}> reject Doctor? </button>

...
useEffect(() => {
      ...
      <aside className="bodyRight1">
        <div className="insideBody">
          ...
          <form className="input"
           ...
           <input type="text" className="InputInfo" id="FirstName2" name="FirstName"  value={onePaitent.fullName}/>
           <input type="text" className="InputInfo" id="LastName2" name="FirstName" value={onePaitent.fileNumber}/>
         
              <div className="input-container">

              <input type="text" id="diabetesType" name="FirstName" placeholder="Your Clinic or Hospital" className="InputInfo" style={{ border: "none" , borderBottom: "solid 1px rgba(128, 128, 128, 0.571)" , width: "97.5%" , marginTop: "1rem" , padding: "0.6rem" , borderRadius: "0"}}
 onChange={(e) => setClinic(e.target.value)}/>
          ...
          <input
                ...
                style={{ border: "none" , borderBottom: "solid 1px rgba(128, 128, 128, 0.571)" , width: "97.5%" , marginTop: "1rem" , padding: "0.6rem" , borderRadius: "0"}}
